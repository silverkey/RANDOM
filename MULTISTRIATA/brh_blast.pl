...
my $file1 = 'Pseudo-Nitzschia_multistriata_final_contigs.fa';
my $file2 = 'Seminavis_robusta_final_contigs.fa';
...
sub run_blastplus {
  ...
  my $command = "$exe -query $query -db $dbname -out $out -num_threads 15 -best_hit_overhang 0.1 -evalue 0.01";
